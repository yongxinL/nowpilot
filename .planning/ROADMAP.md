...
- [ ] **Phase 1: MV3/WXT Runtime + AntD Shells + Workspace** - Installable extension with side panel + standalone surfaces, onboarding, theme, Cmd+K, and shared workspace state
...
|-------|----------------|--------|-----------|
| 1. MV3/WXT Runtime + AntD Shells + Workspace | 9/9 | In Progress|  |
