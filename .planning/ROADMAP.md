...
Plans:
- [ ] 01-01-PLAN.md — Theme persistence end-to-end: chrome.storage.local adapter → ThemeStore → ThemeToggle → SidePanelShell (tracer)
...
|-------|----------------|--------|-----------|
| 1. Project Scaffold & Runtime Foundation | 0/5 | Planned | - |
