...
Plans:
**Wave 1**
- [ ] 05-01-PLAN.md — TRACER: Notes persistence end-to-end — MigrationRunner v4, NoteSchema+LinkParser+NotesDB+MiniSearchNoteIndex+NoteGraph (NOTE-01)
