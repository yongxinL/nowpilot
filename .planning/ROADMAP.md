...
- [x] 08-05-PLAN.md — TeamGQM Foundation: gqmTypes, GQMDataService (WriteJournal-backed CRUD) (ADDON-08 data layer)
...
- [x] 08-08-PLAN.md — ResearchSkill: MCP search detection, graceful degradation, @modelcontextprotocol/sdk (ADDON-09)
