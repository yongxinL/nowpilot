...
- [ ] **STOR-01**: Split storage — IndexedDB for message bodies, chrome.storage.local for metadata, chrome.storage.session for tokens
...
- [ ] **CHAT-08**: One stream per session — abort active before starting new
