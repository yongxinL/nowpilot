...
must_haves:
  truths:
    ...
    - "NoteQA markerless fallback citations carry only REAL snippet noteIds/titles rebuilt by referenceNumber index — fabricated LLM noteId/title never enters the Citation[] (WR-05, D-13, 'never cite non-existent notes')"
