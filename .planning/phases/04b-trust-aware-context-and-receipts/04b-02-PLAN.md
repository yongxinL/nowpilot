...
must_haves:
  truths:
    ...
    - "TrustPolicy.ts exports a typed error carrier for CONTEXT_INSTRUCTION_INJECTION_BLOCKED mirroring the ContextTooLargeError/isContextTooLargeError pattern (ContextOptimizer.ts L64-74): an interface + guard function (e.g. ContextInjectionBlockedError + isContextInjectionBlockedError) used when a retrieved item attempts to redefine policy (O.3 comment L6457-6458, D-4b-04)."
