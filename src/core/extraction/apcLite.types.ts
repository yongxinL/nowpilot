// APCLite structural extraction types — verbatim from PRODUCT_SPEC_v0_1.md
// Appendix C (spec 4393-4448). Panel-side zod schemas; RawNode stays a plain
// serializable interface so the content-script walker (AxDomWalker, 06-02)
// imports it type-only — zod must never enter the content bundle (Pitfall 8).
import { z } from 'zod';
