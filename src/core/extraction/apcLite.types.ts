// src/core/extraction/apcLite.types.ts — Source: Appendix C.1 (verbatim, lines 4411-4464). R-1 canonical home — consumers import (never re-declare) it.
import { z } from 'zod';
...
export const APCLiteNodeSchema: z.ZodType<APCLiteNode> = z.lazy(() =>
  z.object({
    ...
    image: z
      ...
      .optional(),
    form: z
      .object({ name: z.string().optional(), control: FormControlSchema.optional() })
      .optional(),
