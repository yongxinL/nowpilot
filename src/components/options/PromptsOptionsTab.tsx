...
import { App, Tooltip, theme, Popconfirm, Button } from 'antd';
import {
  ReloadOutlined,
  PlusOutlined,
  EditOutlined,
                    ...
                    >
                      ...
                      <Tooltip title="Move Up">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleMovePrompt(showList, index, 'up');
                          }}
                          aria-label="Move Up"
                          ...
                          style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            color: index === 0 ? token.colorTextQuaternary : token.colorTextSecondary,
                            borderRadius: 6,
                          }}
                        />
                      </Tooltip>
                      ...
                      <Tooltip title="Move Down">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleMovePrompt(showList, index, 'down');
                          }}
                          ...
                          style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            color: index === showList.length - 1 ? token.colorTextQuaternary : token.colorTextSecondary,
                            borderRadius: 6,
                          }}
                        />
                      </Tooltip>
                      ...
                      <Tooltip title="Hide from list">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleTogglePromptVisibility(prompt, activeCategory);
                          }}
                          aria-label="Hide from list"
                          icon={<BookmarkHideIcon size={14} />}
                          style={{
                            width: 28,
                            height: 28,
                            minWidth: 28,
                    ...
                    >
                      ...
                      <Tooltip title="Move Up">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleMovePrompt(hideList, index, 'up');
                          }}
                          aria-label="Move Up"
                          icon={<ArrowUpOutlined style={{ fontSize: 12 }} />}
                          style={{
                      ...
                      <Tooltip title="Move Down">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleMovePrompt(hideList, index, 'down');
                          }}
                          aria-label="Move Down"
                          icon={<ArrowDownOutlined style={{ fontSize: 12 }} />}
                          style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            color: index === hideList.length - 1 ? token.colorTextQuaternary : token.colorTextSecondary,
                            borderRadius: 6,
                          }}
                        />
                      </Tooltip>
