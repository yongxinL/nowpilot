...
import { Input, Button, Tag, Tooltip, App, Dropdown, MenuProps, Typography, theme, Popconfirm } from 'antd';
              ...
              <div style={{
                ...
                <div
                  ...
                  style={{
                    ...
                    background: activeCategory === 'all' && !selectedTagFilter ? token.colorFillSecondary : 'transparent',
                    color: activeCategory === 'all' && !selectedTagFilter ? token.colorText : token.colorTextSecondary,
                ...
                >
                  <span style={{
                    ...
                    <FileTextOutlined style={{
                      color: activeCategory === 'all' && !selectedTagFilter ? token.colorPrimary : token.colorTextTertiary,
                    }} />
                    <span>All Notes</span>
                  </span>
                  <span style={{
                ...
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    transition: 'all 150ms ease',
                    background: activeCategory === 'recent' ? token.colorFillSecondary : 'transparent',
                    color: activeCategory === 'recent' ? token.colorText : token.colorTextSecondary,
                ...
                >
                  <span style={{
                    ...
                    <ClockCircleOutlined style={{
                      color: activeCategory === 'recent' ? token.colorPrimary : token.colorTextTertiary,
                    }} />
                ...
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    transition: 'all 150ms ease',
                    background: activeCategory === 'favorites' ? token.colorFillSecondary : 'transparent',
                    color: activeCategory === 'favorites' ? token.colorText : token.colorTextSecondary,
                ...
                >
                  <span style={{
                    ...
                    <StarOutlined style={{
                      color: activeCategory === 'favorites' ? token.colorPrimary : token.colorTextTertiary,
                    }} />
                    <span>Favorites</span>
                  </span>
                  <span style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        >
                          ...
                          <span style={{ color: token.colorPrimary }}>12</span>
                        </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    position: 'relative',
                    background: isSelected ? token.colorBgContainer : 'var(--card)',
                ...
                >
                  <div style={{
                    ...
                    <h4 style={{
                      fontWeight: 600,
                      fontSize: 13,
                      color: isSelected ? token.colorText : 'var(--foreground)',
                      display: '-webkit-box',
                      WebkitLineClamp: 1,
                    ...
                    {/* Action icons on hover or favorite star */}
                    <div
                    ...
                    >
                      {isHovered ? (
                        <>
                          ...
                          <Tooltip title={note.isFavorite ? 'Unfavorite' : 'Favorite'}>
                            <Button
                              type="text"
                              size="small"
                              icon={note.isFavorite ? <StarFilled style={{ color: '#f59e0b', fontSize: 13 }} /> : <StarOutlined style={{ fontSize: 13 }} />}
                              ...
                              style={{
                                ...
                                minWidth: 24,
                                padding: 0,
                                color: note.isFavorite ? '#f59e0b' : token.colorTextSecondary,
                              }}
                            />
                          </Tooltip>
