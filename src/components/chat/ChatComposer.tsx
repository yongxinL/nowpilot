    ...
    >
      ...
      {!isStandalone && (
        ...
        >
          ...
          {/* Right: Icon-only actions (Chat history, New chat) with hit target ≥ 32px */}
          <div
            style={{
              display: 'flex',
              alignItems: 'center',
      ...
      >
        ...
        >
          ...
          {isStandalone && (
            ...
            >
              {/* Left: Pill Workflow Selector & Add Attachment */}
              <div
                style={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              {/* Right: History & New chat with hit targets ≥ 32px */}
              <div
                style={{
                  display: 'flex',
                  alignItems: 'center',
      ...
      >
        ...
        {/* Right: Help & Feedback Icons with hit target ≥ 32px */}
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
